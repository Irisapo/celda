...
RcppExport SEXP _celda_countwFixedL(SEXP labelVecSEXP, SEXP LengthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type labelVec(labelVecSEXP);
    Rcpp::traits::input_parameter< int >::type Length(LengthSEXP);
    rcpp_result_gen = Rcpp::wrap(countwFixedL(labelVec, Length));
    return rcpp_result_gen;
END_RCPP
}
// countNFixedCol
IntegerMatrix countNFixedCol(IntegerMatrix M, IntegerVector labelVec, int nG, int nCol, int RnCol);
RcppExport SEXP _celda_countNFixedCol(SEXP MSEXP, SEXP labelVecSEXP, SEXP nGSEXP, SEXP nColSEXP, SEXP RnColSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type RnCol(RnColSEXP);
    rcpp_result_gen = Rcpp::wrap(countNFixedCol(M, labelVec, nG, nCol, RnCol));
    return rcpp_result_gen;
END_RCPP
}
// reverseCumSum
IntegerVector reverseCumSum(IntegerVector v);
RcppExport SEXP _celda_reverseCumSum(SEXP vSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type v(vSEXP);
    rcpp_result_gen = Rcpp::wrap(reverseCumSum(v));
    return rcpp_result_gen;
END_RCPP
}
// SBP2Prop
NumericVector SBP2Prop(NumericVector a, NumericVector b, double alpha);
RcppExport SEXP _celda_SBP2Prop(SEXP aSEXP, SEXP bSEXP, SEXP alphaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(SBP2Prop(a, b, alpha));
    return rcpp_result_gen;
END_RCPP
}
// eigenMatMultInt
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_celda_countwFixedL", (DL_FUNC) &_celda_countwFixedL, 2},
    {"_celda_countNFixedCol", (DL_FUNC) &_celda_countNFixedCol, 5},
    {"_celda_reverseCumSum", (DL_FUNC) &_celda_reverseCumSum, 1},
    {"_celda_SBP2Prop", (DL_FUNC) &_celda_SBP2Prop, 3},
